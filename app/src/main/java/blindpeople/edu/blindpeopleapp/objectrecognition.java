...
import blindpeople.edu.blindpeopleapp.iplib.ObjectRecognizer;
import blindpeople.edu.blindpeopleapp.iplib.Utilities;

public class objectrecognition extends Activity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    /**
     * SET THE BASE LOADER CALL BACK, IT WILL RUN ON ACTIVITY LOAD ,
     * IT CHECK FOR OPENCV MANAGER , IF NOT PRESENT LINK OPEN FOR
     * GOOLE PLAY STORE
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_objectrecognition);
        scrollLinearLayout = (LinearLayout) findViewById(R.id.scrollLinearLayout);
        detectedObj = "-";
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
        handler = new Handler();

        cameraView = (CameraBridgeViewBase) findViewById(R.id.opencvcam);
        ...
        zeroObjects.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
    ...
    View.OnClickListener viewObject() {
        return new View.OnClickListener() {
            public void onClick(View view) {
                ...
                final Dialog imageDialog = new Dialog(objectrecognition.this);
                imageDialog.getWindow().requestFeature(Window.FEATURE_NO_TITLE);

                LinearLayout dialogLayout = new LinearLayout(objectrecognition.this);
                dialogLayout.setLayoutParams(new ViewGroup.LayoutParams(
                        ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
                dialogLayout.setOrientation(LinearLayout.VERTICAL);
                imageDialog.addContentView(dialogLayout, new ViewGroup.LayoutParams(
                        ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));

                ImageView fullSizeImage = new ImageView(objectrecognition.this);
                fullSizeImage.setLayoutParams(new ViewGroup.LayoutParams(
                ...
                LinearLayout buttonsLayout = new LinearLayout(objectrecognition.this);
                buttonsLayout.setLayoutParams(new ViewGroup.LayoutParams(
                        ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
                buttonsLayout.setOrientation(LinearLayout.HORIZONTAL);

                Button deleteBtn = new Button(objectrecognition.this);
                ...
                Button cancelBtn = new Button(objectrecognition.this);
